...
/// Forward declaration of SkFont class.
ASPOSECPP_3RD_PARTY_CLASS(SkFont);
...
private:
    ...
    void Apply(SkFont& font, float dpi, Text::TextRenderingHint rendering_hint);
    ...
    /// Sets additional rendering parameters to SkFont.
    void UpdateForPpem(uint16_t ppem, SkFont& font);
    /// Sets additional rendering parameters to SkFont.
    void OverrideSkFontSettings(SkFont& font) const;
    ...
    Details::GaspTableData m_gasp_data;
};
