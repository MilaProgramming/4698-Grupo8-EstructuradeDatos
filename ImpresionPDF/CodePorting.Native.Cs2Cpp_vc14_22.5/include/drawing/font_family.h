...
public:
    ...
    /// @param name A font family name
    /// @param font_collection The FontCollection what contains this instance.
    ...
    /// @param generic_family The GenericFontFamilies value to construct the FontFamily.
...
private:
    ...
    /// @param sk_typeface A typeface
    FontFamily(const sk_sp<SkTypeface>& sk_typeface);

    /// Constructs a new instance of FontFamily class and initializes it with the specified typeface.
    /// @param sk_typeface A typeface
    /// @param name The name of @p sk_typeface
    FontFamily(const sk_sp<SkTypeface>& sk_typeface, const SkString &name);
    MEMBER_FUNCTION_MAKE_OBJECT_DECLARATION(FontFamily, CODEPORTING_ARGS(const sk_sp<SkTypeface>& sk_typeface, const SkString &name));
