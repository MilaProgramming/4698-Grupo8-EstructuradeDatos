...
public:
    ...
    /// @param c A character
    /// @returns True if the specified character is a UTF-16 surrogate code unit, otherwise - false
    ...
    /// @param s A string
    /// @param index The index of the character in the specified string
    /// @returns True if the character at the specified index is a UTF-16 surrogate code unit, otherwise - false
    ...
    /// @param str A string
    /// @param index A zero based index in the specified buffer at which the character sequence to test begins 
    ...
    /// @param s A string
    /// @param index The index in the specified string of the character to test
    /// @returns True if the character at the specified index is a UTF-16 high surrogate code unit, otherwise - false
    ...
    /// Determines whether the character at the specified index in the specified string is classified as a white space
    /// character.
    /// @param str A string
    /// @param index A zero-based index in the specified string
    /// @returns True if the character at the specified index is a white space character, otherwise - false
    ...
    /// @param c Character to convert
    /// @returns The specified character in lower case if the specified character is an upper case letter, otherwise - the specified character
    ...
    /// @returns The first and the only character of the specified string if it is exactly 1 character long.
