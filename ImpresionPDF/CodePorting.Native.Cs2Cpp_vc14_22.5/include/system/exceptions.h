...
private: \
    ...
    ASPOSECPP_SHARED_API static String DefaultMessage(const String& member); \
...
EXCEPTION_NAMESPACE(, System) {
    ...
    EXCEPTION_NAMESPACE(System, ComponentModel)
    {
        ...
        DECLARE_INHERITED_EXCEPTION_MSG_AND_EXTRA_MEMBER(InvalidEnumArgumentException, System::Details_ArgumentException, ParamName);
    }
