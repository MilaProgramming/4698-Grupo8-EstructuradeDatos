...
namespace System
{
    ...
    /// Result of delegate equality comparison.
    /// In C++, it is forbidden to directly compare instances of std::function for equality, so at some cases
    /// the only thing possible is to say whether some delegates are alike or not.
    enum class DelegateEquality
    {
        /// Delegates are guaranteed to be the same.
        Equals,
        /// Delegates can be the same, but precise comparison is impossible.
        Alike,
        /// Delegates are guaranteed to be different.
        None
    };
    ...
    public:
        ...
        bool operator==(const Delegate& f) const
        {
            ...
            return m_invoker->compare( *f.m_invoker.get()) != DelegateEquality::None;
        }

        /// Compares two delegates for equality and alikeness.
        /// @param other Delegate to compare the current one with.
        /// @returns The comparison result.
        DelegateEquality CompareDelegateTo(const Delegate &other) const
        {
            if( m_invoker == other.m_invoker )
                return DelegateEquality::Equals;
            if( !m_invoker || !other.m_invoker )
                return DelegateEquality::None;
            return m_invoker->compare(*other.m_invoker.get());
        }
    ...
    private:
        ...
        struct BaseInvoker
        {
            ...
            DelegateEquality compare(const BaseInvoker& other)
            {
            ...
            /// @returns Information on alikeness of between this and @p other invokers.
            virtual DelegateEquality deep_compare(const BaseInvoker& other) const = 0;
        ...
        protected:
            ...
            /// @param other The object to compare with current object
            /// @returns Information on alikeness of between this and @p other invokers.
            DelegateEquality deep_compare(const BaseInvoker& other) const override
            {
                auto obj = dynamic_cast<const FunctionInvoker<T>*>(&other);
                if( obj && m_function == obj->m_function)
                    return DelegateEquality::Equals;
                return DelegateEquality::None;
            }
        ...
        protected:
            /// Always returns a constant value to disable fast comparing part in Delegate::compare function.
            /// deep_compare should be used always.
            const void * fast_compare_object() const override
            {
            ...
            /// Performs deep comparison of the current and the specified objects.
            /// m_function contains "bind expression" - return value of std::bind() function
            /// if content of expressions is same then they are bound (through std::bind)
            /// to the same method the same object
            /// @param other The object to compare with current object
            /// @returns Information on alikeness of between this and @p other invokers.
            DelegateEquality deep_compare(const BaseInvoker& other) const override
            {
                auto obj = dynamic_cast<const BindInvoker*>(&other);
                if (obj && std::memcmp(&m_function, &obj->m_function, sizeof(m_function)) == 0)
                    return DelegateEquality::Equals;
                return DelegateEquality::None;
            }
        ...
        protected:
            ...
            DelegateEquality deep_compare(const BaseInvoker& other) const override
            {
                ...
                if(obj && m_functor == obj->m_functor)
                    return DelegateEquality::Equals;
                return DelegateEquality::None;
            }
        ...
        protected:
            ...
            DelegateEquality deep_compare(const BaseInvoker& other) const override
            {
                if (dynamic_cast<const StdFunctionInvoker*>(&other) != nullptr)
                    return DelegateEquality::Alike;
                return DelegateEquality::None;
            }
        ...
        /// This type should be allocated on stack and passed to functions by value or by reference.
        /// Never use System::SmartPtr class to manage objects of this type.
        /// @tparam MemberType The type of the non-static method invocation of which the current class handles.
        ...
        protected:
            ...
            DelegateEquality deep_compare(const BaseInvoker& other) const override
            {
                ...
                if (obj && m_member_function == obj->m_member_function && (m_obj == obj->m_obj))
                    return DelegateEquality::Equals;
                return DelegateEquality::None;
            }
