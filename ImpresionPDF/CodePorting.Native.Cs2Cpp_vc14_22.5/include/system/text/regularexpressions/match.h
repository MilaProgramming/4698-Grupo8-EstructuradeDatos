...
public:
    ...
    ASPOSECPP_SHARED_API Match(const UStringPtr& source, int index, int length);
...
protected:
    ...
    virtual ASPOSECPP_SHARED_API Object::shared_members_type GetSharedMembers() const override;
#endif
